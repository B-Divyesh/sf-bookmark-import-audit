...
function footer(): string { return `<footer><p><strong>Bookmark Import Audit</strong> checks bookmark HTML files before import.</p><div class="footer-meta"><nav aria-label="Legal"><a href="/privacy" data-route>Privacy</a><a href="/terms" data-route>Terms</a></nav><span>Built by Param Factory</span><span>build 1.0.0-r4</span></div></footer>`; }
